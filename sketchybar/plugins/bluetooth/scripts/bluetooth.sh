...
source "$HOME/.config/sketchybar/plugins/brew/scripts/colors.sh"
source "$HOME/.config/sketchybar/plugins/brew/scripts/icons.sh"
source "$HOME/.config/sketchybar/plugins/brew/scripts/userconfig.sh"
